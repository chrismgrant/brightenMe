...
<html>
	<head>
	<title>brighten.me | add class as tutee</title>
	<meta charset="utf-8">
	...
	<body>
	    ...
	    <div class= "container-fluid">
	        ...
	        <div class = "content">
	            <div class = "hero-unit">
                <form id="registerForm" class="form-stacked" action="try_add_class_tutee.php" method="POST">
                    ...
                    <input class= "btn success large" type="submit" id="submit" value="Add Class - Tutee" name="submit"/>
                </form>
                </div>
                <footer>
